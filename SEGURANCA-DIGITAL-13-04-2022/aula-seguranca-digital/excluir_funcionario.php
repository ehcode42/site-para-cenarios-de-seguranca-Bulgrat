...
<body>
    ...
    <main>
        <form class="container mt-4" onsubmit="verFunc(event)" method="POST">
            <div class="mb-3">
                <label for="id_func" class="form-label">ID do funcionário que você deseja excluir:</label>
...
<script>
    function verFunc(event) {
       ...
       var myInit = {
        ...
        fetch('http://localhost:50/aula-seguranca-digital/api/delete.php/?id=' + id, myInit)
